cat > ~/Desktop/build_camera_corpus.py <<'PY'
import csv, re
from pathlib import Path
from pypdf import PdfReader

BASE = Path("/Users/camillagazzola/Desktop/data/camera")
OUT_META = BASE / "camera_metadata_leg18_19.csv"
...
def pdf_to_text_and_meta(leg: int):
    ...
    for pdf_path in sorted(pdf_dir.glob("sed*.pdf")):
        seduta = pdf_path.stem.replace("sed", "")  # '0001'
        ...
        rows.append({
            ...
            "source_url_pdf": f"https://documenti.camera.it/leg{leg}/resoconti/assemblea/html/sed{seduta}/stenografico.pdf",
