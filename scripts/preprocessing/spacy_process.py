...
INPUT_CSV = Path("data/processed/speeches_raw.csv")
OUTPUT_CSV = Path("data/processed/speeches_spacy.csv")
PROGRESS_CSV = Path("data/processed/.spacy_progress.csv")  # Temporary file
